...
def draw_window(red,yellow,red_bullets,yellow_bullets,red_health,yellow_health):
    ...
    yellow_health_text = HEALTH_FONT.render("Helath: " + str(yellow_health),1,WHITE)
...
def yellow_handle_pressed(key_pressed,yellow):
    if key_pressed [pygame.K_a] and yellow.x > 0 :
        yellow.x -= 5
    if key_pressed [pygame.K_d] and yellow.x < BORDER.x - 45 :
        yellow.x += 5
    if key_pressed [pygame.K_w] and yellow.y > 5:
        yellow.y -= 5
    if key_pressed [pygame.K_s] and yellow.y + 60 < 500:
        yellow.y += 5

def red_handle_pressed(key_pressed,red):
    if key_pressed [pygame.K_RIGHT] and red.x + 30 < WIDTH:
        red.x += 5
    if key_pressed [pygame.K_LEFT] and red.x - 30 > BORDER.x:
        red.x -= 5
    if key_pressed [pygame.K_UP] and red.y > 5:
        red.y -= 5
    if key_pressed [pygame.K_DOWN] and red.y + 60 < 500:
        red.y += 5
...
def main():
    ...
    while run:
        ...
        red_handle_pressed(keys_pressed,red)
